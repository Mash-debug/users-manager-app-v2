  ...
  return (
    <>
      ...
      <Flex justify="flex-start" vertical>
        ...
        <Flex align="center" justify="space-around" style={{height: "fit-content", padding: 32}}>
          <Typography.Text style={{ width: "50%", textAlign: "justify", fontSize: "1.1rem", fontWeight: 600, color: "#f857a6"}}>
        ...
        <Flex align="center" justify="space-around" style={{height: "fit-content", backgroundColor: "#f857a6", padding: 32}}>
          <img src={featuresUser} width="25%" style={{}} alt="User" />
          <Typography.Text style={{ width: "50%", textAlign: "justify", fontSize: "1.1rem", fontWeight: 600, color: "white"}}>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem, rem
            in magni eaque pariatur quam accusantium totam mollitia dolore.
            Saepe eius eos quia sunt possimus est, nihil dignissimos rem
            repellendus! Recusandae, vitae suscipit accusantium praesentium,
